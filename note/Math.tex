...
\DeclareMathOperator{\sign}{sign} % some sign function different from \sgn
\DeclareMathOperator{\outdeg}{outdeg} % outdeg in graph theory for directed graph
...
\newcommand{\II}{\mathbb{I}} % identity matrix for algebraic combinatorics
\newcommand{\JJ}{\mathbb{J}} % matrix with 1 in all entries for algebraic combinatorics
\newcommand{\LL}{\mathbb{L}} % Laplacian matrix definition
\newcommand{\MM}{\mathbb{M}} % incidence matrix
\newcommand{\bA}{\mathbb{A}} % adjacency matrix of a graph
\newcommand{\BB}{\mathbb{B}} % Boolean algebra
